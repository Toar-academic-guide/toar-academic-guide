...
export const ICEBREAKER_QUESTIONS: MultiSelectQuestion[] = [
  {
    ...
    options: [
      ...
      {
        id: 'Q1-B',
        title: 'פיצוח לוגי, אלגוריתמי והנדסי:',
        subtitle: 'לפתור בעיות מורכבות, לכתוב קוד או לנתח נתונים מופשטים.',
        weights: { AN: 2, TE: 1, DI: 1 },
      },
      {
        id: 'Q1-C',
        title: 'סקרנות, חקר והבנת העולם:',
        subtitle:
          'להבין לעומק את חוקי הבסיס של היקום, לפענח תופעות מדעיות - מהמוח האנושי ועד לפיזיקה וכימיה.',
        weights: { AN: 2, ER: 1 },
      },
      {
        id: 'Q1-D',
...
export const ARMY_QUESTIONS: MultiSelectQuestion[] = [
  ...
  },
  {
    ...
    options: [
      {
        id: 'ARMY-2A',
        title: 'בירוקרטיה וחוסר יעילות:',
        subtitle: 'הליכים מיותרים, המתנות, בזבוז זמן.',
        weights: { OR: -1 },
      },
      {
        id: 'ARMY-2B',
        title: 'חוסר אוטונומיה:',
        subtitle: 'שאמרו לי מה לעשות בלי מרחב ליוזמה אישית.',
        weights: { OR: -1, LE: -1 },
      },
      {
        id: 'ARMY-2C',
...
export const STYLE_QUESTIONS: MultiSelectQuestion[] = [
  {
    ...
    options: [
      {
        id: 'Q3-A',
        title: 'סביבה תחרותית ומהירה:',
        subtitle: 'עולם של יעדים, תחרות, קצב גבוה ותגמול על הישגים.',
        weights: { LE: 1 },
      },
      {
        id: 'Q3-B',
        title: 'עבודה בשטח ובתנועה:',
        subtitle: 'עבודה מחוץ למשרד הסגור - בסביבה פתוחה, בטבע או בתחומי התפעול והלוגיסטיקה.',
        weights: { TE: 1 },
      },
      {
        id: 'Q3-C',
        title: 'עבודה עצמאית מול מסך:',
        subtitle:
          'התעמקות במשימות מורכבות, ניתוח נתונים, פתרון בעיות או ניהול מערכות דיגיטליות, בסביבה שקטה ובקצב אישי.',
        weights: { DI: 1, AN: 1 },
      },
      {
        id: 'Q3-D',
        title: 'סביבה אנושית וטיפולית:',
        subtitle: 'עבודה המבוססת על אינטראקציה עם אנשים, הקשבה, הדרכה, חינוך או סיוע ישיר.',
        weights: { SO: 2 },
      },
      {
        id: 'Q3-E',
        title: 'מרחב יצירתי ופתוח:',
  ...
  },
  {
    ...
    options: [
      {
        id: 'Q4-A',
        title: 'בבסיס התיאורטי והמחקרי שלו:',
        subtitle: 'מדעים מדויקים, מדעי המוח, ביולוגיה.',
        weights: { AN: 2, ER: 1 },
      },
      {
        id: 'Q4-B',
        title: 'בדרכי היישום שלו בפועל ובשטח:',
        subtitle: 'הנדסות, אדריכלות, חקלאות.',
        weights: { TE: 2 },
      },
      {
        id: 'Q4-C',
        title: 'בפוטנציאל העסקי והכלכלי שלו:',
        subtitle: 'מנהל עסקים, יזמות, כלכלה.',
        weights: { LE: 2 },
      },
      {
        id: 'Q4-D',
        title: 'בזווית האנושית, החברתית והציבורית שלו:',
        subtitle: 'משפטים, פסיכולוגיה, ממשל, חינוך.',
        weights: { SO: 1, ER: 1 },
      },
      {
        id: 'Q4-E',
        title: 'בהרחבת אופקים, סקרנות וחקר תרבויות והגות:',
        subtitle: 'היסטוריה, ארכאולוגיה, פילוסופיה, ספרות.',
        weights: { ER: 2 },
      },
      {
        id: 'Q4-F',
        title: 'בפוטנציאל ליצירה, עיצוב וביטוי עצמי:',
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'Q5-C',
        title: 'המחבר/ת בין אנשים:',
        subtitle:
          'הבנה עמוקה של בני אדם, ניהול הדינמיקה הקבוצתית ויצירת חיבורים בין אנשים ורעיונות.',
        weights: { SO: 2 },
      },
      {
        id: 'Q5-D',
        title: 'הסמכות המקצועית:',
        subtitle:
          'ריכוז הידע המדויק, ירידה לפרטים הקטנים ביותר ווידוא עמידה בסטנדרטים, חוקים ונהלים.',
        weights: { OR: 2 },
      },
      {
        id: 'Q5-E',
  ...
  },
  {
    ...
    options: [
      {
        id: 'Q6-A',
        title: 'להתמקד בלוגיקה ובנתונים:',
        subtitle:
          'לפרק את הבעיה לרכיבים שלה, למצוא את ה"באג" או הכשל הנקודתי, ולתקן את המנגנון הפיזי או הדיגיטלי.',
        weights: { AN: 2, DI: 1 },
      },
      {
        id: 'Q6-B',
        title: 'להתמקד באנשים ובמערכת:',
        subtitle:
          'להסתכל על האקוסיסטם המלא – להבין מי האנשים שמעורבים, איך התהליכים משפיעים זה על זה ואיך משנים את הדינמיקה הכללית.',
        weights: { SO: 2 },
      },
      {
        id: 'Q6-C',
        title: 'לבחון את הבעיה מהיסוד:',
        subtitle:
          'להסתכל על הסיטואציה בצורה ניטרלית, לבדוק אם המבנה הקיים עדיין משרת את המטרה, ובמידת הצורך להציע קונספט חדש.',
        weights: { CR: 1, ER: 1 },
      },
      {
        id: 'Q6-D',
        title: 'לגשת ישר לניסוי וטעייה בשטח:',
        subtitle:
          'לעזוב את התאוריות והדיבורים, לבצע מהלכים מעשיים מהירים ולראות מה באמת עובד במציאות.',
        weights: { TE: 2 },
      },
    ],
  },
...
export const VALUE_SLIDERS: ValueSliderQuestion[] = [
  {
    ...
    leftDescription: 'לדעת שאני מרוויח/ה טוב ויכול/ה לחיות ברמת החיים שנוחה לי.',
    rightLabel: 'עשייה עם משמעות והשפעה',
    rightDescription: 'לדעת שהעבודה שלי עוזרת לאנשים או תורמת לשינוי של משהו שחשוב לי.',
  ...
  },
  {
    ...
    section: 5,
    leftLabel: 'עצמאות',
    leftDescription: 'לנהל את עצמי, לעבוד בקצב שלי.',
    rightLabel: 'שייכות',
  ...
  },
  {
    ...
    leftDescription: 'שאנשים יבינו מה אני עושה, יעריכו את זה, ויראו בזה הצלחה.',
    rightLabel: 'דרך אישית ונכונה לי',
    rightDescription: 'לבחור מסלול שמתאים לי, גם אם הוא לא נתפס כמרשים או יוקרתי.',
...
export const SCREEN_SEQUENCE: Screen[] = [
  // Section 1: Icebreaker
  {
    kind: 'transition',
    section: 1,
    title: 'בואו נכיר אותך',
    subtitle: 'שתי שאלות קצרות על מה שמרגיש לך הכי טבעי',
  },
  ...
  // Section 2: Quick Picks
  {
    ...
    section: 2,
    title: 'כמה זה את/ה?',
    subtitle: '8 משפטים קצרים - כן, אולי, או לא',
  },
  ...
  // Section 4: Style & Preferences
  {
    ...
    section: 4,
    title: 'איך אתה פועל?',
    subtitle: 'חמש שאלות על סגנון העבודה וההעדפות שלך',
  },
  ...
  // Section 5: Values
  {
    ...
    section: 5,
    title: 'מה חשוב לך?',
    subtitle: 'ארבעה צירים - בחר/י את הצד שמושך אותך יותר',
  },
