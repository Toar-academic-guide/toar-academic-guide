...
export const RATING_ITEMS: RatingItem[] = [
  // R
  {
    ...
    id: 'R1',
    dim: 'R',
    text: "האוזניות של חבר נדפקו — המחשבה הראשונה שלך: 'תביא, נפתח ונראה מה הסיפור'.",
  },
  {
    kind: 'rating',
    id: 'R2',
    dim: 'R',
    text: 'כשמשהו בבית מתקלקל, בא לך לתקן אותו בעצמך לפני שמזמינים טכנאי.',
  },
  // I
  {
    kind: 'rating',
    id: 'I1',
    dim: 'I',
    text: 'ראית כותרת מדעית מוזרה ומצאת את עצמך נופל לשרשור מאמרים ב-2 בלילה.',
  },
  {
    kind: 'rating',
    id: 'I2',
    dim: 'I',
    text: 'אתה לא נרגע עד שאתה מבין *למה* משהו עובד, לא רק *איך*.',
  },
  // A
  {
    kind: 'rating',
    id: 'A1',
    dim: 'A',
    text: 'אתה פשוט לא מסוגל להשאיר מצגת או פוסט עם עיצוב מכוער.',
  },
  {
    kind: 'rating',
    id: 'A2',
    dim: 'A',
    text: 'יוצא לך לדמיין רעיונות, סיפורים או יצירות גם כשאתה לא מנסה.',
  },
  // S
  {
    kind: 'rating',
    id: 'S1',
    dim: 'S',
    text: 'מישהו בקבוצה שקט ונראה לא טוב — אתה זה ששם לב וניגש לדבר איתו.',
  },
  {
    kind: 'rating',
    id: 'S2',
    dim: 'S',
    text: 'אנשים נוטים לבוא אליך כשהם צריכים עצה או אוזן קשבת.',
  },
  // E
  {
    kind: 'rating',
    id: 'E1',
    dim: 'E',
    text: 'בפרויקט קבוצתי אתה תופס טבעית את ההגה ומחלק לכולם משימות.',
  },
  {
    kind: 'rating',
    id: 'E2',
    dim: 'E',
    text: 'כיף לך לשכנע אנשים ולמכור להם רעיון שאתה מאמין בו.',
  },
  // C
  {
    kind: 'rating',
    id: 'C1',
    dim: 'C',
    text: 'יש לך סיפוק אמיתי כשהכל מסודר — תיקיות, רשימות, צבעים.',
  },
  {
    kind: 'rating',
    id: 'C2',
    dim: 'C',
    text: 'אתה מרגיש רגוע יותר כשיש תוכנית ברורה ולוז, לא אלתור.',
  },
];
...
export const SITUATIONALS: SituationalItem[] = [
  {
    ...
    options: [
      ...
      {
        text: 'הסמכות המקצועית — מרכז את הידע המדויק, יורד לפרטים ושומר על נהלים',
        weights: { C: 2 },
      },
...
export const SCREEN_SEQUENCE: Screen[] = [
  ...
  // ── חלק 1 · קלאסי ──
  {
    ...
    part: 'חלק 1 מתוך 3',
    title: 'כמה זה אתה?',
    subtitle: '12 משפטים קצרים — דרגו עד כמה כל אחד מתאר אתכם',
    emoji: '💭',
  },
  ...
  // ── חלק 2 · זה או זה ──
  {
    ...
    part: 'חלק 2 מתוך 3',
    title: 'זה או זה',
    subtitle: 'בכל מסך — באיזה צד אתם מזהים את עצמכם יותר?',
    emoji: '⚖️',
  },
  ...
  // ── חלק 3 · מה היית עושה ──
  {
    ...
    part: 'חלק 3 מתוך 3',
    title: 'מה היית עושה?',
    subtitle: 'מצב אחד, שש דרכים להגיב — בחרו את שלכם',
    emoji: '🎬',
  },
