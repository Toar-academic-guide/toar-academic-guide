...
export const BGU_SOURCE_URL =
  'https://bgu4u22.bgu.ac.il/apex/10g/candidate_site/GetRdpData/';
...
const CONFIGS: BguConfig[] = [
  { programId: 'accounting', sourceUrl: baseUrl('p_dep1=142&p_pat1=1&p_spe1=6'), officialProgramId: 'dep142-pat1-spe6', acceptance: 620, rejection: 620, verdict: 'accepted' },
  { programId: 'biology', sourceUrl: baseUrl('p_dep1=205&p_pat1=15'), officialProgramId: 'dep205-pat15', acceptance: 585, rejection: 585, verdict: 'accepted' },
  { programId: 'business', sourceUrl: baseUrl('p_dep1=142&p_pat1=1&p_spe1=1'), officialProgramId: 'dep142-pat1-spe1', acceptance: 620, rejection: 620, verdict: 'accepted' },
  { programId: 'cs', sourceUrl: baseUrl('p_dep1=232&p_pat1=1&p_spe1=3&p_degree_level=1'), officialProgramId: 'dep232-pat1-spe3', acceptance: 720, rejection: 720, verdict: 'accepted' },
  { programId: 'datascience', sourceUrl: baseUrl('p_dep1=232&p_pat1=1&p_spe1=13&p_degree_level=1'), officialProgramId: 'dep232-pat1-spe13', acceptance: 720, rejection: 720, verdict: 'accepted' },
  { programId: 'economics', sourceUrl: baseUrl('p_dep1=142&p_pat1=3'), officialProgramId: 'dep142-pat1-spe3', acceptance: 620, rejection: 620, verdict: 'accepted' },
  { programId: 'ee', sourceUrl: baseUrl('p_dep1=361&p_pat1=1&p_degree_level=1'), officialProgramId: 'dep361-pat1', acceptance: 547, rejection: 547, verdict: 'accepted' },
  { programId: 'me', sourceUrl: baseUrl('p_dep1=362&p_pat1=1&p_degree_level=1'), officialProgramId: 'dep362-pat1', acceptance: 520, rejection: 520, verdict: 'accepted' },
  { programId: 'industrial', sourceUrl: baseUrl('p_dep1=364&p_pat1=1&p_degree_level=1'), officialProgramId: 'dep364-pat1', acceptance: 505, rejection: 505, verdict: 'accepted' },
  { programId: 'medicine', sourceUrl: baseUrl('p_institution=0&p_dep1=471&p_pat1=1&p_degree_level=8'), officialProgramId: 'dep471-pat1-degree8', acceptance: 735, rejection: 735, verdict: 'eligible_to_apply' },
    ...
    ALIASES.flatMap((programIds) =>
      programIds.map((programId) => {
        ...
        return [pairId, {
          ...
          fixtures,
          ledgerReason: 'Verified against BGU official acceptance-conditions JSON, official score replay, current threshold, accepted/below fixtures, and live score-and-verdict proof.',
...
export const BGU_PROGRAM_VERIFICATION_ARTIFACTS = Object.fromEntries(
  Object.entries(BGU_PROGRAM_VERIFICATION_METADATA).map(([pairId, artifact]) => [pairId, {
