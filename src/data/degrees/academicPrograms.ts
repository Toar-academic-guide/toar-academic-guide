...
const R: Record<string, Program['riasecScore']> = {
  ...
  // ── New specialised disciplines ────────────────────────────────────────────
  occupationalTherapy: { R: 2, I: 3, A: 2, S: 5, E: 1, C: 2 },
  marineBiology:       { R: 3, I: 5, A: 1, S: 2, E: 0, C: 2 },
  soundEngineering:    { R: 3, I: 3, A: 4, S: 1, E: 1, C: 2 },
};
...
export const academicPrograms: Program[] = [
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    type: 'academic',
    category: 'מדעי הבריאות',
    riasecScore: R.occupationalTherapy,
    admissionType: 'sekhem',
    admissionRequirements: [],
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    type: 'academic',
    category: 'הנדסה',
    riasecScore: R.soundEngineering,
    admissionType: 'requirements',
    admissionRequirements: [
      'בגרות מלאה',
