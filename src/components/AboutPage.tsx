        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center text-center">
          ...
          <article className="mt-6 max-w-4xl rounded-[1.8rem] border border-white bg-white/78 p-6 shadow-[0_24px_80px_rgba(105,133,190,0.16)] backdrop-blur sm:p-9">
            <p className="text-center text-lg leading-9 text-[#52607f]">
              אנחנו יונתן ועמית, חברים מאז התיכון. למדנו יחד פיזיקה ומחשבים, ובהמשך
              גם שירתנו יחד בצבא. אחרי השחרור כל אחד מאיתנו פנה לדרך אחרת. עמית המשיך
              לעולמות הטכנולוגיה, וכיום עובד בהייטק ולומד מדעי המחשב באופן מקוון
              באוניברסיטת לונדון, מסלול שמצא לאחר מחקר ארוך וחיפוש אחר לימודים שיוכל
              לשלב עם עבודתו. יונתן לומד כיום פסיכולוגיה, ביולוגיה ומדעי המוח
              באוניברסיטת תל אביב. הדרך לשם כללה שבעה ימים פתוחים, שתי פגישות עם יועצת
              תעסוקתית, שני פסיכומטריים, שיפור של שלוש בגרויות ברמת חמש יחידות ושיחות
              עם יותר ממאה אנשים על המסלולים שבחרו, הכול מתוך רצון להבין ולדייק את
              הדרך המתאימה לו. מהחוויות האלה הבנו ששמות של תארים הם רק כותרות. כדי
              לבחור נכון צריך להבין מה באמת לומדים, איך נראים הלימודים והעבודה ביום
              יום ולאן כל מסלול יכול להוביל. את Way הקמנו מתוך צורך שחווינו בעצמנו:
              להפוך צומת עמוסה באפשרויות ובמידע מפוזר לדרך אישית, ברורה ומעשית יותר.
            </p>
          </article>
        </div>
      </main>
