        ...
        <div className="flex items-center justify-between py-4 pl-8 pr-4 sm:pl-12 sm:pr-6">
          ...
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden items-center gap-7 md:flex">
              <button type="button" onClick={() => scrollToSection('how-it-works')} className="cursor-pointer text-base text-slate-900 transition hover:text-slate-600">
                איך זה עובד
              </button>
              <button type="button" onClick={scrollToStart} className="cursor-pointer text-base text-slate-900 transition hover:text-slate-600">
                תחומי לימוד
              </button>
              <button type="button" className="cursor-pointer text-base text-slate-900 transition hover:text-slate-600">
                מי אנחנו
              </button>
            </nav>
          </div>
