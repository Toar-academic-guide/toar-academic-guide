...
const SECTORS: Record<string, { n: string; min: number; max: number }[]> = {
  יהודי: [
    { n: 'תנ״ך', min: 1, max: 2 },
    { n: 'ספרות', min: 1, max: 2 },
    { n: 'הבעה עברית', min: 1, max: 2 },
    { n: 'אנגלית', min: 3, max: 5 },
    { n: 'מתמטיקה', min: 3, max: 5 },
    { n: 'היסטוריה / תע״י', min: 1, max: 2 },
    { n: 'אזרחות', min: 1, max: 2 },
  ],
  ערבי: [
    { n: 'ערבית', min: 1, max: 5 },
    { n: 'עברית', min: 3, max: 5 },
    { n: 'הבעה ערבית', min: 1, max: 2 },
    { n: 'אנגלית', min: 3, max: 5 },
    { n: 'מתמטיקה', min: 3, max: 5 },
    { n: 'היסטוריה ותולדות הערבים', min: 1, max: 2 },
    { n: 'אזרחות', min: 1, max: 2 },
  ],
  דרוזי: [
    { n: 'ערבית', min: 1, max: 5 },
...
const ALL_SUBJECTS: string[] = [
  'אדריכלות', 'אדריכלות ועצוב נוף', 'אומנויות בינתחומי', 'אומנויות הבישול והאפייה המלונאית',
  'אומנות שימושית', 'אופטיקה יישומית', 'אזרחות', 'איטלקית', 'אלקטרוניקה',
  'אלקטרוניקה ומחשבים', 'אמהרית', 'אמנות הקולנוע', 'אמנות חזותית', 'אנגלית',
  'אפסנאות וטכנולוגיה', 'בולגרית', 'בזק', 'ביוטכנולוגיה', 'ביוכימיה', 'ביולוגיה',
  'ביולוגיה חקלאית', 'ביולוגיה לקוסמטיקה', 'בקרת אקלים', 'בקרת מכונות', 'בקרת תהליכים',
  'בריאות הילד וסביבתו', 'גאוגרפיה אדם וסביבה', 'גלוף עץ עצוב וטכנולוגיה', 'גרוזית',
  'גרמנית', 'גרפיקה ממוחשבת', 'גרפיקה עצוב גרפי', 'גרפיקה עצוב וטכנולוגיה',
  'דיפלומטיה ותקשורת בינלאומית', 'דת האסלם', 'הגנת סייבר', 'הדפסת אופסט', 'הולנדית',
  'הונגרית', 'היסטוריה', 'המטוס ומערכותיו', 'המסוק ומערכותיו', 'הנדסת אוטוטק',
  'הסטוריה ואזרחות', 'הסטוריה וגאוגרפיה', 'הסטוריה ותולדות הערבים',
  'הסטוריה ותולדות הערבים ואזרחות', 'הסטוריה ותע"י', 'הסטוריה תע"י ואזרחות',
  'הפקות בתקשורת', 'השפעה ויוזמה חברתית', 'חבור עברי', 'חוק ומשפט', 'חינוך גופני',
  'חנוך גופני וביולוגיה', 'חנוך הילד בגיל הרך', 'חקלאות', 'חשבונאות',
  'חשוב סטטי וקונסטרוקציות', 'חשובי קונסטרוקציות', 'חשמל ואלקטרוניקה ברכב',
  'חשמל ובקרה ימיים', 'טכלוגיה ובדיקת מזון', 'טכנאות שיניים', 'טכנולוגיה מוכללת',
  'טכנולוגיה של הדפוס', 'טכנולוגיה של הקולנוע והטלויזיה', 'טכנולוגיה של טכנאות שיניים',
  'טכנולוגיות בנייה', 'טכנולוגית בנייה', 'טלוויזיה וקולנוע',
  'טפול בחולה פנימי ובחולה כירורג', 'ידיעת העם והמדינה', 'יהדות', 'יהדות ממ"ד', 'יידיש',
  'ייצור רהיטים ונגרות בניין', 'יישומי אוטוטק', 'יישומי ביוטכנולוגיה', 'יישומי מחשב',
  'יישומי פעילויות בחינוך', 'ימאות', 'ימאות ומטאורולוגיה', 'ימאות וספינות',
  'יסודות בעיצוב שיער', 'יסודות תורת המחשב', 'כימיה', 'כימיה אנליטית ותורת המכשירים',
  'כימיה וביולוגיה', 'כימיה וטכסטיל', 'כימיה טכנולוגית', 'כימיה כללית ואורגנית',
  'כימיה כללית ואנאורגנית', 'כימיה לקוסמטיקה', 'כלכלה', 'כלכלה ומשק', 'כתבנות',
  'לאדינו', 'לטינית /רומית', 'לימודי ארץ ישראל וארכיאולוגיה', 'לשון ותקשורת',
  'מבוא למחשבים וענ"א', 'מבוא למחשבים ותכנות', 'מדע התזונה והארוח',
  'מדע וטכנולוגיה לכל', 'מדע חישובי', 'מדעי הבריאות', 'מדעי ההנדסה', 'מדעי החברה',
  'מדעי החיים וחקלאות', 'מדעי הטכנולוגיה', 'מדעי הים', 'מדעי המדינה', 'מדעי המחשב',
  'מדעי הנדסה', 'מדעי הסביבה', 'מדעי התזונה', 'מדעי כדור הארץ',
  'מדעי תחבורה מתקדמת', 'מוט"ב - מדע וטכנולוגיה בחברה', 'מוסיקה', 'מורשת דרוזית',
  'מורשת דת נוצרית', 'מורשת ודת האסלאם', 'מורשת, דת ותרבות במזרח התיכון', 'מזכירות',
  'מזכירות ומנהל', 'מחול', 'מחשבים ומערכות', 'מחשבת ישראל', 'מחשוב ובקרה',
  'מחשוב ובקרה בהתיישבות', 'מידע וידע באינטרנט', 'מידע ונתונים', 'מיכון חקלאי ומערכות',
  'מיקרוביולוגיה', 'מכונאות ימית', 'מכונאות כללית', 'מכונאות מיכון',
  'מכונות חום ותרמודנמיקה', 'מכונות חקלאיות וטרקטורים', 'מכניקה הנדסית', 'מכשירים ופיקוד',
  'מנהיגות ויזמות', 'מנהל וכלכלה', 'מנועי מטוסים ותרמודנמיקה', 'מנועים ומערכות הדראוליות',
  "מע' אלק' וחשמל ברכב", 'מערכות אוטוטק', 'מערכות אלקטואופטיות', 'מערכות אלקטרוניות',
  'מערכות בזק', 'מערכות ביוטכנולוגיה', 'מערכות בקרה ממוחשבות', 'מערכות ומכונאות בחקלאות',
  'מערכות חשמל', 'מערכות חשמל ובקרה ימיות', 'מערכות חשמל רכב', 'מערכות כח ועבודה',
  'מערכות מדענות ממוחשבות', 'מערכות מומחה', 'מערכות מידע וידע', 'מערכות מכון חקלאי',
  'מערכות מכונאות רכב', 'מערכות מכטרוניקה', 'מערכות מכשור ובקרה', 'מערכות ניהול מלונאי',
  'מערכות סיב"מ', 'מערכות פיקוד ובקרה', 'מערכות פקוד ובקרה - מחשבים',
  'מערכות צ.מ.ה - ציוד מכני הנדסי', 'מערכות רפואיות', 'מערכות תוכנה וחמרה', 'מערכות תיב"מ',
  'מערכות תכנון וייצור', 'מערכות תעופה', 'מערכות תעופה ואביזראות מטוסים', 'מערכות תקשוב',
  'מערכות תקשורת', 'מערכת תעוש הבגד', 'מקצוע בין תחומי', 'מתמטיקה', 'נהול התפעול',
  'נהול ומזכירות', 'נהול מוסד ומחסנאות', 'נהול רכש ומלאי', 'נהול שווק ומכירות',
  'ניהול הייצור', 'ניהול התפעול', 'ניהול ומלאי', 'ניהול מלונאי', 'ניהול משאבי אנוש',
  'ניהול תיירותי', 'נתוח מערכות וארגון קבצים', 'סדר דפוס', 'סוציולוגיה',
  'סייעות ברפואת שיניים', 'סינית', 'סלובקית', 'סעוד כללי', 'ספרדית', 'ספרות',
  'ספרות ומחשבת ישראל', 'ספרות ופילוסופיה', 'ספרות ותושבע"פ', 'ספרות ילדים', 'סרבית',
  'סרטוט אדריכלי', 'סרטוט אוטומציה וחשמל', 'סרטוט בניין אדריכלי',
  'סרטוט בניין לקונסטרוקציות', 'סרטוט ואווירודנמיקה', 'סרטוט וטכנולוגיה',
  'סרטוט וטכנולוגיה במיכון חקלאי', 'סרטוט ומנועי מטוסים', 'סרטוט ותורת המנוע והרכב',
  'סרטוט טכני', 'סרטוט מכונות', 'סרטוט מנועי מטוסים ופרקי מכונו', 'סרטוט מפות',
  'ע"ג הוראה והדרכה', 'עבודת גמר', 'עברית', 'עולם הערבים והאיסלם', 'עיצוב',
  'עיצוב אופנה ותלבושות', 'עיצוב שיער וטיפוח החן', 'עצוב גרפי', 'עצוב המוצר',
  'עצוב התכשיט', 'עצוב וטכנולוגיה', 'עצוב חזותי', 'עצוב יהלומים', 'עצוב כללי',
  'עצוב נוף', 'עצוב שיער קוסמטיקה ואיפור', 'ערבית', 'ערבית ומורשת דרוזים',
  'ערבית ותולדות הערבים והאסלם', 'פולנית', 'פורטוגזית', 'פילוסופיה', 'פיסיקה',
  'פסיכולוגיה', 'פסיכולוגיה התפתחותית', 'פרסית', 'ציור טכסטיל', 'ציור שלטים ודקורציה',
  'צילום', "צ'כית", 'צרפתית', 'קוסמטיקה', 'קרמיקה עצוב וטכנולוגיה', 'רבי מלל',
  'רדיו ואלקטרוניקה ימית', 'רומנית', 'רוסית', 'רשום ציור ואסטטיקה בעצוב', 'שווק ומכירות',
  'שיווק וקידום מכירות', 'שייט וניווט חופי', 'תולדות האמנות והבנתה', 'תולדות הלבוש וציורו',
  'תולדות הערבית ואזרחות', 'תולדות עם ישראל', 'תולדות עם ישראל ואזרחות', 'תורכית',
  'תורת הבנייה וחמרי בניין', 'תורת החשמל', 'תורת הטלפון, תקשורת ומיתוג',
  'תורת המבנה, תחשיב ואוטומציה', 'תורת המדידה', 'תורת הניווט הימי', 'תורת הסעוד',
  'תורת הצלום', 'תורת הקולנוע והטלויזיה', 'תורת טכנאות השיניים', 'תושב"ע',
  'תושב"ע ומשפט עברי', 'תחזוקת מערכות מכניות', 'תחזוקת מערכות סלולריות', 'תיאטרון',
  'תיירות', 'תיירות ותפעול משרד נסיעות', 'תכנון הנדסי של מבנים', 'תכנון וסרטוט רהיטים',
  'תכנון ותכנות מערכות', 'תכנון מבלטים ומתקנים', 'תכנון פרקי מכונות', 'תכנון פרקי מכשירים',
  'תכנון צנרת ומבנים', 'תכנון תפריט ומחסנאות', 'תכנות אוטוטק', 'תכשיטנות עצוב וטכנולוגיה',
  'תלמוד', 'תנ"ך', 'תנ"ך וספרות', 'תנ"ך ותושבע"פ', 'תעשייה כימית', 'תעשיית המזון',
  'תפעול מלון', 'תקשורת', 'תקשורת וחברה', 'תרמודינמיקה', 'תרמודינמיקה טכנית',
  'תשתיות מחשוב ותקשוב',
];
...
export default function BagrutCalculatorWizard({ onComplete }: Props) {
  ...
  function updateElectiveUnits(idx: number, v: number) {
    setElectives((prev) =>
      prev.map((e, i) => (i === idx ? { ...e, units: Math.max(1, v) } : e)),
    );
  }
  ...
  const totalUnitsEntered =
    mandGrades.reduce(
      (s, m) => s + (m.grade !== '' && (m.grade as number) > 0 ? m.units : 0),
      0,
    ) +
    electives.reduce(
      (s, e) => s + (e.grade !== '' && (e.grade as number) > 0 ? e.units : 0),
      0,
    );
    ...
    <div dir="rtl" className="overflow-hidden rounded-2xl border border-[#bae6fd]">
      ...
      {step === 1 && (
        <div className="p-7">
          ...
          <p className="mb-5 text-sm text-slate-500">הבחירה קובעת אילו מקצועות חובה יופיעו בשלב הבא</p>
      ...
      {step === 3 && (
        <div className="p-7">
          ...
          <p className="mb-4 text-sm text-slate-500">
            הקלידו שם מקצוע או לחצו על החץ לרשימה המלאה
          </p>
                ...
                >
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <input
                      ...
                      onChange={(ev) =>
                        updateElectiveGrade(i, ev.target.value === '' ? '' : Number(ev.target.value))
                      }
                      className={numInput}
                    />
                  </div>
