...
export default function QuizIntro({ onStart }: Props) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f5f4f0] px-4 py-12">
      ...
      {/* ── Body copy ────────────────────────────────────────────── */}
      <motion.div {...FADE_UP(0.22)} className="max-w-xl mx-auto text-center px-2">
        <p className="text-lg md:text-xl text-slate-700 leading-relaxed">
          כשאנחנו מתחילים לחשוב איזה מין לימודים אקדמאים יוכלו להתאים לנו, אנחנו צריכים קודם להבין{' '}
        ...
        <p className="mt-5 text-lg md:text-xl text-slate-700 leading-relaxed">
          בוא נבנה עכשיו <strong className="font-bold text-slate-900">פרופיל אישי</strong> שיעזור לך
          להתכוונן ולהבין מה האפשרויות שעומדות בפניך.
        </p>

        <p className="mt-5 text-lg md:text-xl text-slate-700 leading-relaxed">
          בשלב הראשון, נתחיל לאפיין את{' '}
          <strong className="font-bold text-slate-900">החוזקות שלך והמשיכה הטבעית שלך</strong>, ולאט
          לאט נסנן יחד את האפשרויות הרלוונטיות ביותר עבורך!
        </p>
      </motion.div>
