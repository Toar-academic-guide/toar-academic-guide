...
export default async function ReviewItemPage({ params }: ReviewItemPageProps) {
  ...
  return (
    <WayPageShell dir="ltr">
      <main className="px-5 py-6 text-slate-950 sm:px-8">
        <div className="mx-auto flex max-w-5xl flex-col gap-6">
          <header className="way-surface p-8">
            <Link
              className="text-sm font-bold text-[#6574dc] underline-offset-4 hover:underline"
          ...
          <ReviewActionPanel canReject={item.actionEligibility.canReject} reviewItemId={item.id} />
