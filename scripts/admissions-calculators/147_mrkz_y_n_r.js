...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מרכז י.נ.ר`,
    institutionType: `מכללה פרטית`,
    location: `, פתח תקווה`,
    programName: `מרכז י.נ.ר`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21053`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21053`,
