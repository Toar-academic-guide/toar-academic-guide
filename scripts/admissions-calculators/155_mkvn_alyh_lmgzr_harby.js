...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכון עליה למגזר הערבי`,
    institutionType: `מכללה פרטית`,
    location: `, באר שבע`,
    programName: `מכון עליה למגזר הערבי`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21175`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21175`,
