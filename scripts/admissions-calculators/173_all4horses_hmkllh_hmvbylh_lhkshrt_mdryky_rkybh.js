// ALL4HORSES- המכללה המובילה להכשרת מדריכי רכיבה
...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `ALL4HORSES- המכללה המובילה להכשרת מדריכי רכיבה`,
    institutionType: `מכללה ציבורית`,
    location: `ALL4HORSES- מושב אודים - , אודים`,
    programName: `ALL4HORSES- המכללה המובילה להכשרת מדריכי רכיבה`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/21346`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21346`,
