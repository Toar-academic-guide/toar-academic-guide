...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `ספרדית בסנטר`,
    institutionType: `מכללה פרטית`,
    location: `0, תל אביב`,
    programName: `ספרדית בסנטר`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/20780`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20780`,
