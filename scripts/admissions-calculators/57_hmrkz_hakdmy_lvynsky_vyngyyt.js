...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המרכז האקדמי לוינסקי-וינגייט`,
    institutionType: `מכללה ציבורית`,
    location: `, אילת`,
    programName: `המרכז האקדמי לוינסקי-וינגייט`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/2727`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/2727`,
