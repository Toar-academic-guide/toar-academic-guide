...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת TechnoloGems`,
    institutionType: `מכללה ציבורית`,
    location: `מכללת TechnoloGems- רמת גן - התע"ש 10, רמת גן`,
    programName: `מכללת TechnoloGems`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/21283`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21283`,
