...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המרכז לבטיחות אש והערכות למצבי חירום`,
    institutionType: `מכללה פרטית`,
    location: `דני היי 38900, קיסריה`,
    programName: `המרכז לבטיחות אש והערכות למצבי חירום`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/20775`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20775`,
