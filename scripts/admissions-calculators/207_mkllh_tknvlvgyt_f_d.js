...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללה טכנולוגית F.D`,
    institutionType: `מכללה ציבורית`,
    location: `מכללת F.D- אונליין - , און ליין`,
    programName: `מכללה טכנולוגית F.D`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/21103`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21103`,
