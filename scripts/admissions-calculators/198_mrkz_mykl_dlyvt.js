...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מרכז מיכל דליות`,
    institutionType: `מכללה פרטית`,
    location: `אונליין - , און ליין`,
    programName: `מרכז מיכל דליות`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21299`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21299`,
