...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `sv college`,
    institutionType: `מכללה פרטית`,
    location: `sv college- אונליין - , און ליין`,
    programName: `sv college`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21151`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21151`,
