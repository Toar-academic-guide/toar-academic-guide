...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת Boutique Tattoo`,
    institutionType: `מכללה ציבורית`,
    location: `מכללת Boutique Tattoo Academy- ראשון לציון - , ראשון לציון`,
    programName: `מכללת Boutique Tattoo`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/21320`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21320`,
