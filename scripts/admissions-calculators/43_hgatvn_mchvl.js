...
function getAdmissionsData() {
  return {
    institutionName: `הגעתון - מחול`,
    institutionType: `מכללה פרטית`,
    location: `קיבוץ געתון`,
    programName: `הגעתון - מחול`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://www.kcdc.co.il`,
    admissionRequirements: {
      sekhemThreshold: `מסגרת מקצועית למחול (להקת/בית ספר הגעתון – KCDC). הקבלה מבוססת אודישן (שיעור/סדנת מחול) והתרשמות מיכולת; מבוסס כישרון, ללא דרישות אקדמיות.
(מומלץ לאמת מועדי אודישן ותנאים באתר.)`,
      calculatorUrl: `https://www.kcdc.co.il`,
      minPsychometric: "משתנה לפי מסלול",
      minMatriculation: "משתנה לפי מסלול",
      specificRequirements: `מסגרת מקצועית למחול (להקת/בית ספר הגעתון – KCDC). הקבלה מבוססת אודישן (שיעור/סדנת מחול) והתרשמות מיכולת; מבוסס כישרון, ללא דרישות אקדמיות.
(מומלץ לאמת מועדי אודישן ותנאים באתר.)`,
      additionalFilters: "ראיון או ועדת קבלה בהתאם לדרישות החוג"
    },
    alternativePaths: {
      preparatoryProgram: `לא רלוונטי — מסגרת מקצועית למחול ללא מכינה אקדמית; קבלה מבוססת אודישן.`,
      transitionTrack: ``,
    ...
    dataReliability: {
      officialSource: `https://www.kcdc.co.il`,
      checkDate: `2026-06-24`,
      confidenceLevel: "גבוהה (על בסיס בדיקה רשמית)",
      barriersAndNotes: `ייתכנו מלגות/מסלולי תמיכה למחול ומימון מהפיקדון לתכניות מוכרות — לאימות מול הגעתון/KCDC.`
    }
  };
}
