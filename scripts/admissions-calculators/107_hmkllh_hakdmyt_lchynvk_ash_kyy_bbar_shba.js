...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המכללה האקדמית לחינוך ע''ש קיי בבאר שבע`,
    institutionType: `מכללה ציבורית`,
    location: `עזריאל ניצני 6, באר שבע`,
    programName: `המכללה האקדמית לחינוך ע''ש קיי בבאר שבע`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/1196`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/1196`,
