...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המרכז ללימודי חוץ והמשך ספיר`,
    institutionType: `מכללה פרטית`,
    location: `, שדרות`,
    programName: `המרכז ללימודי חוץ והמשך ספיר`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/18398`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/18398`,
