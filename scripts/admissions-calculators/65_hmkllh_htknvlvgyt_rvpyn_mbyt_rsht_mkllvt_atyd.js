...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המכללה הטכנולוגית רופין\\- מבית רשת מכללות עתיד`,
    institutionType: `מכללה ציבורית`,
    location: `50, עמק חפר`,
    programName: `המכללה הטכנולוגית רופין\\- מבית רשת מכללות עתיד`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/17741`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/17741`,
