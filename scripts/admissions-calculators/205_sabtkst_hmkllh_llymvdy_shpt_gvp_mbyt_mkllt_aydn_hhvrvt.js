...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `סאבטקסט\\- המכללה ללימודי שפת גוף מבית מכללת עידן ההורות`,
    institutionType: `מכללה ציבורית`,
    location: `אונליין - , און ליין`,
    programName: `סאבטקסט\\- המכללה ללימודי שפת גוף מבית מכללת עידן ההורות`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/21327`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21327`,
