...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המכללה העסקית של לשכת המסחר ת"א והמרכז`,
    institutionType: `מכללה ציבורית`,
    location: `, תל אביב`,
    programName: `המכללה העסקית של לשכת המסחר ת"א והמרכז`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/18811`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/18811`,
