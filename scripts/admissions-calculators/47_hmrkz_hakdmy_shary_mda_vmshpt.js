...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המרכז האקדמי שערי מדע ומשפט`,
    institutionType: `מכללה ציבורית`,
    location: `דפנה 9, רעננה`,
    programName: `המרכז האקדמי שערי מדע ומשפט`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/946`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/946`,
