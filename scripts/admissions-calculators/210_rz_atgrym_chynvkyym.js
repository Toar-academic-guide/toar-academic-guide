...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `רז אתגרים חינוכיים`,
    institutionType: `מכללה`,
    location: `קניון אורות , אור עקיבא`,
    programName: `רז אתגרים חינוכיים`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/20638`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20638`,
