...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת הנות`,
    institutionType: `מכללה ציבורית`,
    location: `אונליין - , און ליין`,
    programName: `מכללת הנות`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/20515`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20515`,
