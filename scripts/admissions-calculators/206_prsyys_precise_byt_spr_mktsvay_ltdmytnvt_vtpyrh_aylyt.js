// פרסייס\- precise בית ספר מקצועי לתדמיתנות ותפירה עילית
...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `פרסייס\\- precise בית ספר מקצועי לתדמיתנות ותפירה עילית`,
    institutionType: `מכללה פרטית`,
    location: `חיפה - , חיפה`,
    programName: `פרסייס\\- precise בית ספר מקצועי לתדמיתנות ותפירה עילית`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21336`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21336`,
