...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `פסגות \\- בית הספר לשמאות`,
    institutionType: `מכללה פרטית`,
    location: `סניף און ליין - , און ליין`,
    programName: `פסגות \\- בית הספר לשמאות`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21156`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21156`,
