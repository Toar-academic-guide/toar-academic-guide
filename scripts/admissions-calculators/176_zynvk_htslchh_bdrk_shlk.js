...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `זינוק \\- הצלחה בדרך שלך`,
    institutionType: `מכללה`,
    location: `אונליין - , און ליין`,
    programName: `זינוק \\- הצלחה בדרך שלך`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21351`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21351`,
