...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `היחידה הארצית לחקירות וביטחון`,
    institutionType: `מכללה פרטית`,
    location: `בית החייל , באר שבע`,
    programName: `היחידה הארצית לחקירות וביטחון`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/18622`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/18622`,
