...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המכללה הטכנולוגית כנרת`,
    institutionType: `מכללה ציבורית`,
    location: `צמח - 0, צמח`,
    programName: `המכללה הטכנולוגית כנרת`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/17751`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/17751`,
