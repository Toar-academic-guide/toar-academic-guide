...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המכללה האקדמית צפת`,
    institutionType: `מכללה ציבורית`,
    location: `ירושלים 11, צפת`,
    programName: `המכללה האקדמית צפת`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/3148`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/3148`,
