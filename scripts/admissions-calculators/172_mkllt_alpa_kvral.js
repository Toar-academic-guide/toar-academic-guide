...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת אלפא קוראל`,
    institutionType: `מכללה ציבורית`,
    location: `, אום אל-פחם`,
    programName: `מכללת אלפא קוראל`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/21344`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21344`,
