...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת הבית`,
    institutionType: `מכללה ציבורית`,
    location: `הארד 9, תל אביב`,
    programName: `מכללת הבית`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/20732`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20732`,
