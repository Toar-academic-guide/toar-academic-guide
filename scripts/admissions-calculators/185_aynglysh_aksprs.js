...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `אינגליש אקספרס`,
    institutionType: `מכללה פרטית`,
    location: `, און ליין`,
    programName: `אינגליש אקספרס`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21343`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21343`,
