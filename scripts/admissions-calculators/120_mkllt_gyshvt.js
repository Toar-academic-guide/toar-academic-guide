...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת גישות`,
    institutionType: `מכללה ציבורית`,
    location: `סניף באר שבע - , באר שבע`,
    programName: `מכללת גישות`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/18919`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/18919`,
