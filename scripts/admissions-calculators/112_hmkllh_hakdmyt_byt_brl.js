...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המכללה האקדמית בית ברל`,
    institutionType: `מכללה ציבורית`,
    location: `, כפר סבא`,
    programName: `המכללה האקדמית בית ברל`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/18417`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/18417`,
