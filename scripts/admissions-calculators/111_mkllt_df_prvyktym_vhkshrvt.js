...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת DF פרויקטים והכשרות`,
    institutionType: `מכללה ציבורית`,
    location: `מכללת DF פרויקטים והכשרות- אונליין - , און ליין`,
    programName: `מכללת DF פרויקטים והכשרות`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/21328`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21328`,
