...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המרכז האקדמי למשפט ולעסקים`,
    institutionType: `מכללה ציבורית`,
    location: `בן-גוריון 26, רמת גן`,
    programName: `המרכז האקדמי למשפט ולעסקים`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/954`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/954`,
