...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכון עליה`,
    institutionType: `מכללה פרטית`,
    location: `רבי טרפון 2, אשדוד`,
    programName: `מכון עליה`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/20371`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20371`,
