...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `קידום \\- בגרויות`,
    institutionType: `מכללה`,
    location: `און ליין - ,`,
    programName: `קידום \\- בגרויות`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/20747`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20747`,
