...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המכללה הטכנולוגית באר שבע \\- הנדסאים`,
    institutionType: `מכללה ציבורית`,
    location: `שבע - בזל 71, באר שבע`,
    programName: `המכללה הטכנולוגית באר שבע \\- הנדסאים`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/21021`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21021`,
