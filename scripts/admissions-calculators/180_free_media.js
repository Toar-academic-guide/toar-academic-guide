...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `FREE MEDIA`,
    institutionType: `מכללה פרטית`,
    location: `FREE MEDIA - יגאל אלון 94, תל אביב`,
    programName: `FREE MEDIA`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/20701`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20701`,
