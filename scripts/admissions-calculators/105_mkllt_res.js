...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת RES`,
    institutionType: `מכללה ציבורית`,
    location: `מכללת RES אונליין - , און ליין`,
    programName: `מכללת RES`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/20670`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20670`,
