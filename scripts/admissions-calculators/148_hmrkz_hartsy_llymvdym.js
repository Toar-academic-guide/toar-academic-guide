...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המרכז הארצי ללימודים`,
    institutionType: `מכללה פרטית`,
    location: `, און ליין`,
    programName: `המרכז הארצי ללימודים`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21063`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21063`,
