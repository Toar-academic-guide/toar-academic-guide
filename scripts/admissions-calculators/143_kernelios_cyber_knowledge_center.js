...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `KERNELiOS - Cyber Knowledge Center`,
    institutionType: `מכללה פרטית`,
    location: `KERNELiOS - יוסף לישנסקי 27, ראשון לציון`,
    programName: `KERNELiOS - Cyber Knowledge Center`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/20990`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20990`,
