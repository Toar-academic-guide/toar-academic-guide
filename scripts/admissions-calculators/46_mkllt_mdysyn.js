...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת מדיסין`,
    institutionType: `מכללה ציבורית`,
    location: `שלוחת חיפה - האשלג 3, חיפה`,
    programName: `מכללת מדיסין`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/867`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/867`,
