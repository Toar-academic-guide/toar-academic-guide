...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `דיפלומה \\- ביה"ס ללימודי תעודה והסמכה`,
    institutionType: `מכללה פרטית`,
    location: `, און ליין`,
    programName: `דיפלומה \\- ביה"ס ללימודי תעודה והסמכה`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/18554`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/18554`,
