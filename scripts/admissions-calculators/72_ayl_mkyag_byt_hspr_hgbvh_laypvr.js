...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `איל מקיאג'\\- בית הספר הגבוה לאיפור`,
    institutionType: `מכללה פרטית`,
    location: `, אשדוד`,
    programName: `איל מקיאג'\\- בית הספר הגבוה לאיפור`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/17945`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/17945`,
