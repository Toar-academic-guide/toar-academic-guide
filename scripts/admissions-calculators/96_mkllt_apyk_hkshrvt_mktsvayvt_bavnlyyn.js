// מכללת אפיק \- הכשרות מקצועיות באונליין
...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת אפיק \\- הכשרות מקצועיות באונליין`,
    institutionType: `מכללה ציבורית`,
    location: `, און ליין`,
    programName: `מכללת אפיק \\- הכשרות מקצועיות באונליין`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/20774`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20774`,
