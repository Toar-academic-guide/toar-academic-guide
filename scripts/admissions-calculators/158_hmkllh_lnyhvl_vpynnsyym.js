...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המכללה לניהול ופיננסיים`,
    institutionType: `מכללה ציבורית`,
    location: `אונליין - , און ליין`,
    programName: `המכללה לניהול ופיננסיים`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/21240`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21240`,
