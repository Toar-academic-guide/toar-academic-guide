...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `נטאשה דנונה`,
    institutionType: `מכללה פרטית`,
    location: `תל אביב - המרד 25, תל אביב`,
    programName: `נטאשה דנונה`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/18784`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/18784`,
