...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המכללה האקדמית הרצוג`,
    institutionType: `מכללה ציבורית`,
    location: `שלוחת ירושלים - , ירושלים`,
    programName: `המכללה האקדמית הרצוג`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/1925`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/1925`,
