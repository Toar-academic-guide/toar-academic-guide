...
function getAdmissionsData() {
  return {
    institutionName: `הסטודיו למשחק ניסן נתיב`,
    institutionType: `מכללה פרטית`,
    location: `תל אביב וירושלים`,
    programName: `הסטודיו למשחק ניסן נתיב`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://www.nissan-nativ.co.il`,
    admissionRequirements: {
      sekhemThreshold: `סטודיו מקצועי למשחק (לא אקדמי). הקבלה מבוססת אודישן (מונולוגים/סצנות + סדנת אימפרוביזציה) וראיון; אין דרישת בגרות. גיל 18+.`,
      calculatorUrl: `https://www.nissan-nativ.co.il`,
      minPsychometric: "משתנה לפי מסלול",
      minMatriculation: "משתנה לפי מסלול",
      specificRequirements: `סטודיו מקצועי למשחק (לא אקדמי). הקבלה מבוססת אודישן (מונולוגים/סצנות + סדנת אימפרוביזציה) וראיון; אין דרישת בגרות. גיל 18+.`,
    ...
    dataReliability: {
      officialSource: `https://www.nissan-nativ.co.il`,
