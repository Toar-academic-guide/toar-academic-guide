...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת ממי`,
    institutionType: `מכללה ציבורית`,
    location: `אונליין - , און ליין`,
    programName: `מכללת ממי`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/21350`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21350`,
