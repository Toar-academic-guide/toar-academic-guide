...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `בית הספר לנדל"ן יסודות`,
    institutionType: `מכללה פרטית`,
    location: `, און ליין`,
    programName: `בית הספר לנדל"ן יסודות`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/20607`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20607`,
