...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המרכז להכשרה חינוכית`,
    institutionType: `מכללה פרטית`,
    location: `אונליין - , און ליין`,
    programName: `המרכז להכשרה חינוכית`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21222`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21222`,
