...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת BPM`,
    institutionType: `מכללה פרטית`,
    location: `תל אביב`,
    programName: `מכללת BPM`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://www.bpm.org.il`,
    admissionRequirements: {
      sekhemThreshold: `מכללה מקצועית למוסיקה והפקה (לא אקדמית). הקבלה מבוססת ראיון/מבדק התאמה לפי מסלול (הפקה מוסיקלית, סאונד, ביצוע ועוד); אין דרישת בגרות/פסיכומטרי.
(מומלץ לאמת פרטי קבלה לכל מסלול באתר.)`,
      calculatorUrl: `https://www.bpm.org.il`,
      minPsychometric: "משתנה לפי מסלול",
      minMatriculation: "משתנה לפי מסלול",
      specificRequirements: `מכללה מקצועית למוסיקה והפקה (לא אקדמית). הקבלה מבוססת ראיון/מבדק התאמה לפי מסלול (הפקה מוסיקלית, סאונד, ביצוע ועוד); אין דרישת בגרות/פסיכומטרי.
(מומלץ לאמת פרטי קבלה לכל מסלול באתר.)`,
      additionalFilters: "ראיון או ועדת קבלה בהתאם לדרישות החוג"
    },
    alternativePaths: {
      preparatoryProgram: `לא רלוונטי — מכללה מקצועית למוסיקה והפקה ללא מכינה אקדמית; קבלה לפי מסלול.`,
      transitionTrack: ``,
    ...
    dataReliability: {
      officialSource: `https://www.bpm.org.il`,
      checkDate: `2026-06-24`,
      confidenceLevel: "גבוהה (על בסיס בדיקה רשמית)",
      barriersAndNotes: `מוסד פרטי בתשלום; ייתכנו מלגות/פריסת תשלומים ומימון מהפיקדון לתכניות מוכרות — לאימות מול המכללה.`
    }
  };
