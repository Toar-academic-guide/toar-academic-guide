...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `ארגון מנהלי רכש ולוגיסטיקה בישראל`,
    institutionType: `מכללה פרטית`,
    location: `אונליין - , און ליין`,
    programName: `ארגון מנהלי רכש ולוגיסטיקה בישראל`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21331`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21331`,
