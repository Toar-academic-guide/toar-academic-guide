...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `סדנאות הבמה והמסך`,
    institutionType: `מכללה פרטית`,
    location: `אמץ 13, תל אביב`,
    programName: `סדנאות הבמה והמסך`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21342`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21342`,
