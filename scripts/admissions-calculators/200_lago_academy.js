...
async function getAdmissionsData() {
  const fallbackData = {
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21306`,
