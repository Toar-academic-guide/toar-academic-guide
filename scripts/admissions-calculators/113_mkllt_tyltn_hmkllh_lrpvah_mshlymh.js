...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת תילתן המכללה לרפואה משלימה`,
    institutionType: `מכללה ציבורית`,
    location: `מכללה לרפואה משלימה- אונליין - , און ליין`,
    programName: `מכללת תילתן המכללה לרפואה משלימה`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/18499`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/18499`,
