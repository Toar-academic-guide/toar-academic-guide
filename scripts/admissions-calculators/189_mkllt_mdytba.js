...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת מדיטבע`,
    institutionType: `מכללה ציבורית`,
    location: `פתח תקווה - אבי אורן 3, פתח תקווה`,
    programName: `מכללת מדיטבע`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/19972`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/19972`,
