...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `ג'ון ברייס הדרכה`,
    institutionType: `מכללה פרטית`,
    location: `שדרות ההסתדרות 46, חיפה`,
    programName: `ג'ון ברייס הדרכה`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21259`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21259`,
