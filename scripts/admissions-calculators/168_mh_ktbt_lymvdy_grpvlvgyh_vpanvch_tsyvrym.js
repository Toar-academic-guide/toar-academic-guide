// "מה כתבת?" (לימודי גרפולוגיה ופענוח ציורים)
...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `"מה כתבת?" (לימודי גרפולוגיה ופענוח ציורים)`,
    institutionType: `מכללה פרטית`,
    location: `, און ליין`,
    programName: `"מה כתבת?" (לימודי גרפולוגיה ופענוח ציורים)`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/21322`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21322`,
