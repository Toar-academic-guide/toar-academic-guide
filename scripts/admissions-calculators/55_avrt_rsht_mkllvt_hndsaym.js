...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `אורט \\- רשת מכללות הנדסאים`,
    institutionType: `מכללה ציבורית`,
    location: `סנונית 51, כרמיאל`,
    programName: `אורט \\- רשת מכללות הנדסאים`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/2052`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/2052`,
