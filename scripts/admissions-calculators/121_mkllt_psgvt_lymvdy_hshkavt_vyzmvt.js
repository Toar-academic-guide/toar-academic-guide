...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת פסגות \\- לימודי השקעות ויזמות`,
    institutionType: `מכללה ציבורית`,
    location: `סניף אונליין - , און ליין`,
    programName: `מכללת פסגות \\- לימודי השקעות ויזמות`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/19336`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/19336`,
