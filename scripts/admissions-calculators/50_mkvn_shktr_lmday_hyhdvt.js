...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכון שכטר למדעי היהדות`,
    institutionType: `מכללה פרטית`,
    location: `אונליין - , און ליין`,
    programName: `מכון שכטר למדעי היהדות`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/1567`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/1567`,
