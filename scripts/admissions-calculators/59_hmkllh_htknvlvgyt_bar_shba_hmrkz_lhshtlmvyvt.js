...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המכללה הטכנולוגית באר שבע המרכז להשתלמויות`,
    institutionType: `מכללה ציבורית`,
    location: `שבע - בזל 71, באר שבע`,
    programName: `המכללה הטכנולוגית באר שבע המרכז להשתלמויות`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/2957`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/2957`,
