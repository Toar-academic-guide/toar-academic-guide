// אמפייר אם – האקדמיה למצוינות במקצועות היופי
...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `אמפייר אם – האקדמיה למצוינות במקצועות היופי`,
    institutionType: `מכללה ציבורית`,
    location: `, אשדוד`,
    programName: `אמפייר אם – האקדמיה למצוינות במקצועות היופי`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/21338`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21338`,
