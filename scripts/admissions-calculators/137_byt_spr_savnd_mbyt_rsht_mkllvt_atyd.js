...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `בית ספר "סאונד" מבית רשת מכללות עתיד`,
    institutionType: `מכללה ציבורית`,
    location: `ריב"ל 5, תל אביב`,
    programName: `בית ספר "סאונד" מבית רשת מכללות עתיד`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/20848`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20848`,
