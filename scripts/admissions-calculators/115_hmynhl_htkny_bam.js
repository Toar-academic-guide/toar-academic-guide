...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המינהל הטכני בע"מ`,
    institutionType: `מכללה פרטית`,
    location: `סניף און ליין - , און ליין`,
    programName: `המינהל הטכני בע"מ`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/18507`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/18507`,
