...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המכינה הקדם אקדמית סמי שמעון`,
    institutionType: `מכללה ציבורית`,
    location: `זבוטינסקי 84, אשדוד`,
    programName: `המכינה הקדם אקדמית סמי שמעון`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/3512`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/3512`,
