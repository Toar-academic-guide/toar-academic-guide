...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `המכינה הקדם אקדמית בתל חי`,
    institutionType: `מכללה ציבורית`,
    location: `0, תל חי`,
    programName: `המכינה הקדם אקדמית בתל חי`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/3238`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/3238`,
