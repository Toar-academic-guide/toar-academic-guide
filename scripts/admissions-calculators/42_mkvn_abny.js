...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכון אבני`,
    institutionType: `מכללה פרטית`,
    location: `תל אביב`,
    programName: `מכון אבני`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://www.michlalot.co.il/avni/main`,
    admissionRequirements: {
      sekhemThreshold: `בית ספר ותיק לאמנות (לא אקדמי, תל אביב). הקבלה מבוססת תיק עבודות וראיון אישי; מבוסס כישרון.
(מומלץ לאמת דרישות באתר.)`,
      calculatorUrl: `https://www.michlalot.co.il/avni/main`,
      minPsychometric: "משתנה לפי מסלול",
      minMatriculation: "משתנה לפי מסלול",
      specificRequirements: `בית ספר ותיק לאמנות (לא אקדמי, תל אביב). הקבלה מבוססת תיק עבודות וראיון אישי; מבוסס כישרון.
(מומלץ לאמת דרישות באתר.)`,
      additionalFilters: "ראיון או ועדת קבלה בהתאם לדרישות החוג"
    },
    alternativePaths: {
      preparatoryProgram: `לא רלוונטי — ביה״ס לאמנות ללא מכינה אקדמית; קבלה מבוססת תיק וראיון.`,
      transitionTrack: ``,
    ...
    dataReliability: {
      officialSource: `https://www.michlalot.co.il/avni/main`,
