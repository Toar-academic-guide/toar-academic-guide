...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `אורט \\- רשת מכללות ללימודי תעודה והסמכה`,
    institutionType: `מכללה ציבורית`,
    location: `סנונית 51, כרמיאל`,
    programName: `אורט \\- רשת מכללות ללימודי תעודה והסמכה`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/21041`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/21041`,
