...
function getAdmissionsData() {
  return {
    institutionName: `אסטלה - קונדיטוריה`,
    institutionType: `מכללה פרטית`,
    location: `תל אביב`,
    programName: `אסטלה - קונדיטוריה`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://www.estella.co.il`,
    admissionRequirements: {
      sekhemThreshold: `- לימודי תעודה מקצועיים בלבד.
- אין דרישות סף אקדמיות (ללא בגרות או פסיכומטרי).
- נדרשת פגישת ייעוץ, הכוונה והתאמה אישית.`,
      calculatorUrl: `https://www.estella.co.il`,
      minPsychometric: "משתנה לפי מסלול",
      minMatriculation: "משתנה לפי מסלול",
      specificRequirements: `- לימודי תעודה מקצועיים בלבד.
- אין דרישות סף אקדמיות (ללא בגרות או פסיכומטרי).
- נדרשת פגישת ייעוץ, הכוונה והתאמה אישית.`,
    ...
    alternativePaths: {
      ...
      transitionTrack: `- קבלה חופשית ללא תנאי סף על בסיס פגישת התאמה ומוטיבציה.`,
      priorStudies: "קבלה על סמך לימודים אקדמיים קודמים או דיפלומת הנדסאי",
      exceptionsCommittee: "קיימת ועדת חריגים למועמדים מתאימים",
      specialPopulations: `- קבלה חופשית ללא תנאי סף על בסיס פגישת התאמה ומוטיבציה.`,
      otherPaths: `- קבלה חופשית ללא תנאי סף על בסיס פגישת התאמה ומוטיבציה.`
    },
    alternatives: {
    ...
    dataReliability: {
      officialSource: `https://www.estella.co.il`,
