...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `A.B.S - בית הספר למסחר, יזמות ועסקים`,
    institutionType: `מכללה פרטית`,
    location: `A.B.S בית ספר למסחר ועסקים- און ליין - , און ליין`,
    programName: `A.B.S - בית הספר למסחר, יזמות ועסקים`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/20751`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20751`,
