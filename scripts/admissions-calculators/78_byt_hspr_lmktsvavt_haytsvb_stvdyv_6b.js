...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `בית הספר למקצועות העיצוב \\- סטודיו 6B`,
    institutionType: `מכללה פרטית`,
    location: `סטודיו 6B - סניף חיפה - האשלג 22, חיפה`,
    programName: `בית הספר למקצועות העיצוב \\- סטודיו 6B`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/18211`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/18211`,
