// מעלה - לקולנוע ואמנויות
// מזהה פריט בלוח Monday: 12220697938

function getAdmissionsData() {
  return {
    institutionName: `מעלה - לקולנוע ואמנויות`,
    institutionType: `מכללה פרטית`,
    location: `ירושלים`,
    programName: `מעלה - לקולנוע ואמנויות`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://www.maale.co.il`,
    admissionRequirements: {
      sekhemThreshold: `בית ספר לקולנוע ואמנויות (לא אקדמי, ירושלים; בעל אופי דתי). הקבלה מבוססת ראיון אישי ומטלות/תיק עבודות; מבוסס כישרון ולא ציונים.
(מומלץ לאמת דרישות באתר.)`,
      calculatorUrl: `https://www.maale.co.il`,
      minPsychometric: "משתנה לפי מסלול",
      minMatriculation: "משתנה לפי מסלול",
      specificRequirements: `בית ספר לקולנוע ואמנויות (לא אקדמי, ירושלים; בעל אופי דתי). הקבלה מבוססת ראיון אישי ומטלות/תיק עבודות; מבוסס כישרון ולא ציונים.
(מומלץ לאמת דרישות באתר.)`,
      additionalFilters: "ראיון או ועדת קבלה בהתאם לדרישות החוג"
    },
    alternativePaths: {
      preparatoryProgram: `לא רלוונטי — ביה״ס לקולנוע ואמנויות ללא מכינה אקדמית; קבלה מבוססת ראיון ומטלות.`,
      transitionTrack: ``,
    ...
    dataReliability: {
      officialSource: `https://www.maale.co.il`,
      checkDate: `2026-06-24`,
      confidenceLevel: "גבוהה (על בסיס בדיקה רשמית)",
      barriersAndNotes: `ייתכנו מלגות סיוע/הצטיינות וקרנות לקולנוע; חיילים משוחררים — אפשרות מימון מהפיקדון. (לאימות מול ביה״ס.)`
    }
  };
}
