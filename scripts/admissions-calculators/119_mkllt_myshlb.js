...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `מכללת מישלב`,
    institutionType: `מכללה ציבורית`,
    location: `אונליין - , און ליין`,
    programName: `מכללת מישלב`,
    degreeType: `תואר אקדמי`,
    officialUrl: `https://yoram.walla.co.il/institute/18762`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/18762`,
