...
async function getAdmissionsData() {
  const fallbackData = {
    institutionName: `חרשן\\- כשהשקעה והצלחה נפגשים`,
    institutionType: `מכללה`,
    location: `כשהשקעה והצלחה נפגשים - סניף ת"א - , תל אביב`,
    programName: `חרשן\\- כשהשקעה והצלחה נפגשים`,
    degreeType: `תעודה מקצועית`,
    officialUrl: `https://yoram.walla.co.il/institute/20872`,
    ...
    dataReliability: {
      officialSource: `https://yoram.walla.co.il/institute/20872`,
